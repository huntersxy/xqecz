...
function openImageViewer(e: Event) {
  const el = e.currentTarget as HTMLElement | null
  const img = el?.querySelector('img') as HTMLImageElement | null
  if (!img) return
  new Viewer(img, { navbar: false, zIndex: 10000 }).show()
}
        ...
        <div v-if="content" class="animate-[fadeIn_0.3s_ease]">
          ...
          >
            ...
            <div>
              ...
              ></div>
              <div v-else-if="content.type === 'image'" class="flex justify-center" @click="openImageViewer">
                <img
