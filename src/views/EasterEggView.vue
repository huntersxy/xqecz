  ...
  <div class="min-h-screen p-2 sm:p-5 flex justify-center">
    <div class="w-full max-w-[1200px] overflow-hidden bg-[var(--theme-surface)] rounded-xl shadow-lg shadow-black/5 border border-[var(--theme-card-border)]">
      ...
      <div class="p-4 sm:p-6">
        ...
        <div class="bg-[var(--theme-card-bg)] rounded-xl p-3 sm:p-4 mb-4 sm:mb-6 shadow-md shadow-black/8 border border-[var(--theme-card-border)]">
          <div class="mb-3 sm:mb-4 pb-3 sm:pb-4 border-b border-[var(--theme-card-border)]">
            ...
            <div class="flex flex-wrap gap-2 sm:gap-3 mt-2">
              <a href="https://space.bilibili.com/98560079" target="_blank" class="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--theme-surface)] border border-[var(--theme-card-border)] rounded-lg text-xs sm:text-sm theme-text hover:bg-[var(--theme-hover-bg)] hover:text-[var(--theme-primary)] hover:border-[var(--theme-primary)]/30 transition-all">
              ...
              <a href="https://github.com/huntersxy" target="_blank" class="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--theme-surface)] border border-[var(--theme-card-border)] rounded-lg text-xs sm:text-sm theme-text hover:bg-[var(--theme-hover-bg)] hover:text-[var(--theme-primary)] hover:border-[var(--theme-primary)]/30 transition-all">
                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div class="mb-3 sm:mb-4 pb-3 sm:pb-4 border-b border-[var(--theme-card-border)]">
            ...
            <div class="flex flex-wrap gap-2 sm:gap-3 mt-2">
              <a href="https://space.bilibili.com/3546778043419394" target="_blank" class="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--theme-surface)] border border-[var(--theme-card-border)] rounded-lg text-xs sm:text-sm theme-text hover:bg-[var(--theme-hover-bg)] hover:text-[var(--theme-primary)] hover:border-[var(--theme-primary)]/30 transition-all">
                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.54 4.46c-1.3-1.3-3.02-2-4.86-2H9.32c-1.84 0-3.56.7-4.86 2L.46 9.32c-1.3 1.3-2 3.02-2 4.86v1.36c0 1.84.7 3.56 2 4.86l4.86 4.86c1.3 1.3 3.02 2 4.86 2h1.36c1.84 0 3.56-.7 4.86-2l4.86-4.86c1.3-1.3 2-3.02 2-4.86v-1.36c0-1.84-.7-3.56-2-4.86l-4.86-4.86zM12 16.5c-2.49 0-4.5-2.01-4.5-4.5s2.01-4.5 4.5-4.5 4.5 2.01 4.5 4.5-2.01 4.5-4.5 4.5z"/>
                </svg>
                <span>小泉动漫</span>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            >
              ...
              <div class="p-3">
                ...
                <span :class="[content.type === 'video' ? 'bg-[var(--theme-danger)]/10 text-[var(--theme-danger)]' : content.type === 'image' ? 'bg-[var(--theme-success)]/10 text-[var(--theme-success)]' : content.type === 'link' ? 'bg-[var(--theme-secondary)]/10 text-[var(--theme-secondary)]' : 'bg-[var(--theme-primary)]/10 text-[var(--theme-primary)]']" class="px-2 py-0.5 rounded-full text-xs font-medium">
        ...
        <div v-if="totalPages > 1" class="flex justify-center items-center gap-3 pt-3 border-t border-[var(--theme-card-border)]">
          <button
            @click="goToPage(page - 1)"
            :disabled="page <= 1"
            class="flex items-center gap-1.5 px-3 py-2 bg-[var(--theme-surface)] border border-[var(--theme-card-border)] rounded-lg text-sm theme-text hover:bg-[var(--theme-hover-bg)] hover:text-[var(--theme-primary)] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M15 19l-7-7 7-7"/>
            </svg>
          ...
          <span class="text-sm theme-text-secondary">第 {{ page }} / {{ totalPages }} 页</span>
          <button
            @click="goToPage(page + 1)"
